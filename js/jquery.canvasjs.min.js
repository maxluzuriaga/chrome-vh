/* ALTERED TO GET RID OF WHITE OVERLAY WHEN EXPLODING SEGMENT */
			...
			if (animationParameter !== null && animationParameter.frame < animationParameter.maxFrames) {
				...
				for (var i = 0; i < dataPoints.length; i++) {
					...
					if (endAngle > startAngle) {
						...
						/* commented out so that highlight only occurs when you hover over a segment */
	...
	ToolTip.prototype.highlightObjects = function (entries) {
		...
		for (var i = 0; i < entries.length; i++) {
			...
			if (dataSeries.type === "line" || dataSeries.type === "stepLine" || dataSeries.type === "spline" || dataSeries.type === "scatter"
				...
				drawSegment(overlaidCanvasCtx, eventObject.center, eventObject.radius, "white", dataSeries.type, eventObject.startAngle, eventObject.endAngle, 0.3);
