/* ALTERED TO GET RID OF WHITE OVERLAY WHEN SELECTING SEGMENT */
	...
	ToolTip.prototype.highlightObjects = function (entries) {
		...
		for (var i = 0; i < entries.length; i++) {
			...
			if (dataSeries.type === "line" || dataSeries.type === "stepLine" || dataSeries.type === "spline" || dataSeries.type === "scatter"
				...
				drawSegment(overlaidCanvasCtx, eventObject.center, eventObject.radius, "white", dataSeries.type, eventObject.startAngle, eventObject.endAngle, 0);
